 ...
 * 
 * This component displays when a user visits /submit and has existing drafts.
 * It shows a list of their in-progress drafts (similar to ProductHunt's "Your existing in progress posts")
 * 
 * Flow:
 * 1. User visits /submit
 * 2. If user has drafts → Show this screen
 * 3. User can:
 *    - Continue a draft (navigates to /submit?draft=<id>)
 *    - Start new submission (clears form and shows form)
 *    - Delete a draft
 * 4. If no drafts → Skip this screen, go directly to form
 * 
 * Visual Layout:
 * ┌─────────────────────────────────────────────────────────┐
 * │              Submit Your Launch                         │
...
const DraftSelectionScreen = ({
    ...
    if (drafts.length === 0) {
        // No drafts, don't show this screen
        return null;
    }
