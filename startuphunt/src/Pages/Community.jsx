...
const CommunityComingSoon = () => {
    return (
        <div className="min-h-screen bg-white text-gray-900 flex flex-col items-center justify-center p-4">
            ...
            <div className="relative max-w-4xl mx-auto space-y-8 z-10 text-center">
                <div className="flex items-center justify-center space-x-6 animate-fade-in">
                    <Settings className="h-16 w-16 text-indigo-600 animate-spin-slow" />
                    <div className="text-8xl font-extrabold text-gray-900 drop-shadow-md">
                        <span className="bg-clip-text text-transparent bg-gradient-to-r from-indigo-600 to-blue-600">Building</span>
                    </div>
                    <Sunrise className="h-16 w-16 text-yellow-500 animate-pulse-slow" />
                </div>
                <h1 className="text-5xl md:text-7xl font-extrabold text-gray-900 leading-tight tracking-tighter mt-8 animate-fade-in-up">
                    Our New Community
                    <br className="hidden md:block" />
                    is <span className="bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-indigo-600">Coming Soon.</span>
                </h1>
                <p className="text-xl md:text-2xl text-gray-700 mt-6 animate-fade-in-up-delay">
